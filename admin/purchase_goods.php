...
<style>
<?php echo $customCss; ?>
.purchase-page{max-width:1480px;margin:0 auto}.purchase-toolbar{display:flex;gap:12px;justify-content:space-between;align-items:flex-end;flex-wrap:wrap}.purchase-filter{display:grid;grid-template-columns:minmax(180px,240px) minmax(180px,240px) minmax(240px,1fr) auto;gap:12px;align-items:end}.purchase-grid{display:grid;grid-template-columns:repeat(4,minmax(190px,1fr));gap:14px}.table-shell{overflow:auto;border:1px solid #e2e8f0;border-radius:16px;background:#fff}.goods-table{min-width:1180px;width:100%;border-collapse:separate;border-spacing:0}.goods-table th{position:sticky;top:0;background:#f8fafc;z-index:2;font-size:12px;text-transform:uppercase;letter-spacing:.04em;color:#475569}.goods-table th,.goods-table td{padding:12px 14px;border-bottom:1px solid #e2e8f0;vertical-align:middle}.goods-table select{min-width:380px}.goods-table input{min-height:40px}.purchase-actions-top{position:sticky;top:58px;z-index:25;display:flex;justify-content:space-between;align-items:center;gap:12px;flex-wrap:wrap;margin:16px 0;padding:12px 14px;border:1px solid #dbeafe;border-radius:16px;background:rgba(248,250,252,.96);box-shadow:0 8px 18px rgba(15,23,42,.06);backdrop-filter:blur(6px)}.purchase-actions-top .left{color:#64748b;font-size:13px}.num{text-align:right}.muted{color:#64748b;font-size:12px}.total-box{display:flex;justify-content:flex-end;gap:12px;align-items:center;margin-top:12px;font-weight:800}.total-box span{font-size:22px}.action-bar{display:flex;gap:10px;justify-content:flex-end;flex-wrap:wrap;margin-top:12px}.badge-soft{display:inline-flex;border:1px solid #bfdbfe;background:#eff6ff;color:#1d4ed8;border-radius:999px;padding:4px 10px;font-size:12px;font-weight:700}@media(max-width:1100px){.purchase-filter{grid-template-columns:1fr 1fr}.purchase-grid{grid-template-columns:1fr 1fr}}@media(max-width:900px){.purchase-grid,.purchase-filter{grid-template-columns:1fr}.purchase-toolbar{display:block}.action-bar .btn,.purchase-actions-top .btn{width:100%}.purchase-actions-top{position:static}}
</style>
</head>
<body>
